...
module cutecar_addr_router_001_default_decode
  #(
...
module cutecar_addr_router_001
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD11 = log2ceil(64'h4003090 - 64'h4003080); 
    localparam PAD12 = log2ceil(64'h4003098 - 64'h4003090); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h4003098;
    ...
    cutecar_addr_router_001_default_decode the_default_decode(
    ...
    // ( 0x4003070 .. 0x4003080 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 27'h4003070   ) begin
    ...
    // ( 0x4003090 .. 0x4003098 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 27'h4003090   ) begin
